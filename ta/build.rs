...
const OPTEE_PATH: &'static str = "../rust-optee-trustzone-sdk/optee/";
...
fn main() {
    ...
    let compiler_include = format!("-I{}{}", OPTEE_PATH, "toolchains/aarch64/aarch64-linux-gnu/libc/usr/include/");
    let stdlib_include = format!("-I{}{}", OPTEE_PATH, "toolchains/aarch64/lib/gcc/aarch64-linux-gnu/8.2.1/include/");
